...
"Sudd Library" and the ANZ NEXUS name/logos are reserved separately — see [NOTICE.md](NOTICE.md). Non-affiliation and no-warranty terms are in [DISCLAIMER.md](DISCLAIMER.md).
